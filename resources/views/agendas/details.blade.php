                  ...
                  <div class="about-text">
                    ...
                    <div class="mb-3">
                      <span class="post-author">
                        ...
                        <i class="fa fa-clock-o" aria-hidden="true"></i>  {{ $item->date_start }} |
                        <i class="fa fa-users" aria-hidden="true"></i>  {{ $item->quota }} |
                        <i class="fa fa-user" aria-hidden="true"></i> Administrator
                      </span>
                    </div>
                        <img class="img-fluid mb-3" src="/{{$item->thumbnail}}" alt="thumbnail" width="740px;">
                        <p>{!! $item->desc !!}</p>                        
                    </div>
                </div>
            </div>
            <div class="container">
              <div class="row">
                  <div class="col-lg mt-3 mb-3">
                      <a href="{{ $item->link }}" class="btn btn-join "><i class="fa fa-sign-in" aria-hidden="true"></i>
                        Gabung Sekarang</a>
                  </div>
              </div>
          </div>      
